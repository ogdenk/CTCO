...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_peaktime.setGeometry(QtCore.QRect(1090, 680, 81, 16))
        self.label_peaktime.setObjectName("label_peaktime")
        self.peakTime = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.peakTime.setGeometry(QtCore.QRect(1179, 680, 111, 24))
        ...
        self.MTT.setGeometry(QtCore.QRect(1179, 730, 111, 24))
        ...
        self.label_sterror.setGeometry(QtCore.QRect(1120, 630, 51, 21))
        self.label_sterror.setObjectName("label_sterror")
        self.standardError = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.standardError.setGeometry(QtCore.QRect(1180, 630, 111, 24))
        ...
        self.label_MTT.setGeometry(QtCore.QRect(1040, 730, 131, 20))
        self.label_MTT.setObjectName("label_MTT")
        self.cardiacOutput = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.cardiacOutput.setGeometry(QtCore.QRect(1180, 580, 111, 24))
        ...
        self.label_CO.setGeometry(QtCore.QRect(1030, 580, 141, 20))
        self.label_CO.setObjectName("label_CO")
        self.CurveFitResults = QtWidgets.QGroupBox(self.centralwidget)
        self.CurveFitResults.setGeometry(QtCore.QRect(840, 390, 421, 151))
        ...
        self.beta.setGeometry(QtCore.QRect(160, 40, 101, 24))
        ...
        self.AUC.setGeometry(QtCore.QRect(260, 100, 141, 24))
        ...
        self.label_beta.setGeometry(QtCore.QRect(170, 20, 31, 16))
        ...
        self.label_toffset.setGeometry(QtCore.QRect(310, 20, 31, 16))
        self.label_toffset.setObjectName("label_toffset")
        self.t0 = QtWidgets.QPlainTextEdit(self.CurveFitResults)
        self.t0.setGeometry(QtCore.QRect(300, 40, 101, 24))
        ...
        self.label_AUC.setGeometry(QtCore.QRect(270, 80, 31, 16))
        ...
        self.calcAndPlot_btn.setGeometry(QtCore.QRect(420, 600, 111, 32))
        ...
        self.resetPlot.setGeometry(QtCore.QRect(420, 640, 93, 32))
        self.resetPlot.setObjectName("resetPlot")
        self.HUtoIodineConversion = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.HUtoIodineConversion.setGeometry(QtCore.QRect(770, 630, 81, 24))
        ...
        self.baselineInput.setGeometry(QtCore.QRect(770, 580, 81, 24))
        ...
        self.label_tinterval.setGeometry(QtCore.QRect(860, 680, 101, 20))
        ...
        self.createCSV.setGeometry(QtCore.QRect(1172, 770, 121, 32))
        self.createCSV.setObjectName("createCSV")
        self.clearBASE_btn = QtWidgets.QPushButton(self.centralwidget)
        self.clearBASE_btn.setGeometry(QtCore.QRect(220, 640, 113, 32))
        self.clearBASE_btn.setObjectName("clearBASE_btn")
        self.MPAmean = QtWidgets.QTextBrowser(self.centralwidget)
        self.MPAmean.setGeometry(QtCore.QRect(130, 750, 101, 21))
        self.MPAmean.setObjectName("MPAmean")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(20, 750, 101, 20))
        self.label.setObjectName("label")
        self.BASEmean = QtWidgets.QTextBrowser(self.centralwidget)
        self.BASEmean.setGeometry(QtCore.QRect(130, 780, 101, 21))
        self.BASEmean.setObjectName("BASEmean")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(20, 780, 91, 20))
        self.label_2.setObjectName("label_2")
        self.DirSelect = QtWidgets.QPushButton(self.centralwidget)
        self.DirSelect.setGeometry(QtCore.QRect(410, 750, 141, 51))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.DirSelect.setFont(font)
        self.DirSelect.setObjectName("DirSelect")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(650, 20, 71, 20))
        self.label_3.setObjectName("label_3")
        self.copier = QtWidgets.QPushButton(self.centralwidget)
        self.copier.setGeometry(QtCore.QRect(1020, 770, 141, 32))
        self.copier.setObjectName("copier")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.copier.setText(_translate("MainWindow", "Copy to Clipboard"))
